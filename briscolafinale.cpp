//FILE DI TESTO AURORA 
//PARTE CALCOLO PUNTEGGIO E FUNZIONI PER LA SCELTA DELLE CARTE ELISA
...
int stampaCarteGiocatore(Partita &p) {
    ...
    cout << "CARTA COMPUTER: " << p.manoCorrente.cartaATerra.carta << " di " << p.manoCorrente.cartaATerra.seme << " (valore: " << p.manoCorrente.cartaATerra.valore << ')' << endl;//mette la carta buttata dal giocatore precendente(computre)
